...
#RHS: right hand side (return query or attribute)
#Slack: Slack in the current solution  (how to query or modify attribute)
#PI: dual value in the current solution (return y)
#SARHSLow: smallest right hand side value
#SARHSUp: highest right hand side value
